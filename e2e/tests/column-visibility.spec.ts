...
test.describe('Column Visibility Persistence', () => {
  ...
  test('should maintain column visibility with other state', async ({ page }) => {
    await page.goto('/');
  ...
  test('should handle multiple column visibility changes', async ({ page }) => {
    ...
    const initialHeaders = await page.locator('[data-testid^="header-"]').count();
    ...
    const afterHideHeaders = await page.locator('[data-testid^="header-"]').count();
    ...
    const afterShowHeaders = await page.locator('[data-testid^="header-"]').count();
  ...
  test('should clear column visibility from localStorage when reset to default', async ({ page }) => {
    await page.goto('/');
  ...
  test('should work with table sorting and filtering while column is hidden', async ({ page }) => {
    await page.goto('/');
